...
namespace EntFrm.Framework.Utility
{
    ...
    public class FileUpHelper
    {
        ...
        private FileUpHelper(FileUpdate updateProcess, string filePath, string fileName)
        {
        ...
        private FileUpHelper(FileUpdate updateProcess, string filePath)
        ...
        static public void StartWatching(FileUpdate updateProcess, string filePath)
        {
            ...
            new FileUpHelper(updateProcess, filePath);
        }
    }
}
