...
namespace EntFrm.Framework.Utility
{
    ...
    {/// <summary>
     ...
     /// <returns>二维码图片</returns>
        public static Bitmap EncodeQrImage(string contents, int width = 300, int height = 300)
        {
        ...
        public static Bitmap EncodeQrImage(string contents, Image middleImg, int width = 300, int height = 300)
        {
            if (string.IsNullOrEmpty(contents))
            {
                return null;
        ...
        public static string DecodeQrImage(string imgfile)
        {
            // create a barcode reader instance
            IBarcodeReader reader = new BarcodeReader();
            // load a bitmap
            Bitmap barcodeBitmap = (Bitmap)Image.FromFile(imgfile);
