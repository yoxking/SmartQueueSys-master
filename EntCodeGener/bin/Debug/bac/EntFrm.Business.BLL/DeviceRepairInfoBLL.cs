...
{
    public class DeviceRepairInfoBLL
    {
        ...
        public  DeviceRepairInfoBLL(string sConnStr, string sAppCode)
        {
           this.connStr = sConnStr;
           this.appCode = sAppCode;
        }

        private  void ValidateRequired(DeviceRepairInfo info)
        {
            /*if (info != null)
            {
        ...
        private  void ValidateRepeat(DeviceRepairInfo  info)
        {
            /*if (info != null)
            {
                 try
                 {
                     IDeviceRepairInfo  infoDAL = DeviceRepairInfoFactory.Create(this.connStr, this.appCode);
        ...
        public  bool AddNewRecord(DeviceRepairInfo info)
        {
            try
            {
        ...
        public  bool UpdateRecord(DeviceRepairInfo info)
        {
            try
            {
                 //ValidateRequired(info);
        ...
        public  DeviceRepairInfo GetRecordByNo(string sNo)
        {
            if (sNo.Length > 0)
            {
                try
                {
                  IDeviceRepairInfo  infoDAL = DeviceRepairInfoFactory.Create(this.connStr, this.appCode);
                  DeviceRepairInfoCollections infoColl = infoDAL.GetRecordsByNo(sNo);
        ...
        public  DeviceRepairInfoCollections GetRecordsByPaging(ref int pageCount,int pageIndex,int pageSize,string condition)
        {
          try
          {
             IDeviceRepairInfo  infoDAL = DeviceRepairInfoFactory.Create(this.connStr, this.appCode);
           ...
           s_model.sTableName = "DeviceRepairInfo";
        ...
        public  DeviceRepairInfoCollections GetRecordsByPaging(SqlModel s_model)
        {
            if (s_model!=null)
            {
                try
