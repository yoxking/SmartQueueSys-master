...
{
    public class LabSummaryInfoBLL
    {
        ...
        public  LabSummaryInfoBLL(string sConnStr, string sAppCode)
        {
           this.connStr = sConnStr;
           this.appCode = sAppCode;
        }

        private  void ValidateRequired(LabSummaryInfo info)
        {
            /*if (info != null)
            {
        ...
        private  void ValidateRepeat(LabSummaryInfo  info)
        {
            /*if (info != null)
            {
                 try
                 {
                     ILabSummaryInfo  infoDAL = LabSummaryInfoFactory.Create(this.connStr, this.appCode);
        ...
        public  bool AddNewRecord(LabSummaryInfo info)
        {
            try
            {
        ...
        public  bool UpdateRecord(LabSummaryInfo info)
        {
            try
            {
                 //ValidateRequired(info);
        ...
        public  LabSummaryInfo GetRecordByNo(string sNo)
        {
            if (sNo.Length > 0)
            {
                try
                {
                  ILabSummaryInfo  infoDAL = LabSummaryInfoFactory.Create(this.connStr, this.appCode);
                  LabSummaryInfoCollections infoColl = infoDAL.GetRecordsByNo(sNo);
        ...
        public  LabSummaryInfoCollections GetRecordsByPaging(ref int pageCount,int pageIndex,int pageSize,string condition)
        {
          try
          {
             ILabSummaryInfo  infoDAL = LabSummaryInfoFactory.Create(this.connStr, this.appCode);
           ...
           s_model.sTableName = "LabSummaryInfo";
        ...
        public  LabSummaryInfoCollections GetRecordsByPaging(SqlModel s_model)
        {
            if (s_model!=null)
            {
                try
