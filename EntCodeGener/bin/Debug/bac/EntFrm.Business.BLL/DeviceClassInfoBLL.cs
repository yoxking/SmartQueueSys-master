...
{
    public class DeviceClassInfoBLL
    {
        ...
        public  DeviceClassInfoBLL(string sConnStr, string sAppCode)
        {
           this.connStr = sConnStr;
           this.appCode = sAppCode;
        }

        private  void ValidateRequired(DeviceClassInfo info)
        {
            /*if (info != null)
            {
        ...
        private  void ValidateRepeat(DeviceClassInfo  info)
        {
            /*if (info != null)
            {
                 try
                 {
                     IDeviceClassInfo  infoDAL = DeviceClassInfoFactory.Create(this.connStr, this.appCode);
        ...
        public  bool AddNewRecord(DeviceClassInfo info)
        {
            try
            {
        ...
        public  bool UpdateRecord(DeviceClassInfo info)
        {
            try
            {
                 //ValidateRequired(info);
        ...
        public  DeviceClassInfo GetRecordByNo(string sNo)
        {
            if (sNo.Length > 0)
            {
                try
                {
                  IDeviceClassInfo  infoDAL = DeviceClassInfoFactory.Create(this.connStr, this.appCode);
                  DeviceClassInfoCollections infoColl = infoDAL.GetRecordsByNo(sNo);
        ...
        public  DeviceClassInfoCollections GetRecordsByPaging(ref int pageCount,int pageIndex,int pageSize,string condition)
        {
          try
          {
             IDeviceClassInfo  infoDAL = DeviceClassInfoFactory.Create(this.connStr, this.appCode);
           ...
           s_model.sTableName = "DeviceClassInfo";
        ...
        public  DeviceClassInfoCollections GetRecordsByPaging(SqlModel s_model)
        {
            if (s_model!=null)
            {
                try
