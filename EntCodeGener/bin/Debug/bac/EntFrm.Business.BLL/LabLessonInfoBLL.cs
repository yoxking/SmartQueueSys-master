...
namespace EntFrm.Business.BLL
{
    public class LabLessonInfoBLL
    {
        ...
        public  LabLessonInfoBLL(string sConnStr, string sAppCode)
        {
           this.connStr = sConnStr;
           this.appCode = sAppCode;
        }

        private  void ValidateRequired(LabLessonInfo info)
        {
            /*if (info != null)
            {
        ...
        private  void ValidateRepeat(LabLessonInfo  info)
        {
            /*if (info != null)
            {
                 try
                 {
                     ILabLessonInfo  infoDAL = LabLessonInfoFactory.Create(this.connStr, this.appCode);
        ...
        public  bool AddNewRecord(LabLessonInfo info)
        {
            try
            {
        ...
        public  bool UpdateRecord(LabLessonInfo info)
        {
            try
            {
                 //ValidateRequired(info);
        ...
        public  LabLessonInfo GetRecordByNo(string sNo)
        {
            if (sNo.Length > 0)
            {
                try
                {
                  ILabLessonInfo  infoDAL = LabLessonInfoFactory.Create(this.connStr, this.appCode);
                  LabLessonInfoCollections infoColl = infoDAL.GetRecordsByNo(sNo);
        ...
        public  LabLessonInfoCollections GetRecordsByPaging(ref int pageCount,int pageIndex,int pageSize,string condition)
        {
          try
          {
             ILabLessonInfo  infoDAL = LabLessonInfoFactory.Create(this.connStr, this.appCode);
           ...
           s_model.sTableName = "LabLessonInfo";
        ...
        public  LabLessonInfoCollections GetRecordsByPaging(SqlModel s_model)
        {
            if (s_model!=null)
            {
                try
