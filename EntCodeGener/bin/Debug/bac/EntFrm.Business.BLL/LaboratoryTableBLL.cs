...
{
    public class LaboratoryTableBLL
    {
        ...
        public  LaboratoryTableBLL(string sConnStr, string sAppCode)
        {
           this.connStr = sConnStr;
           this.appCode = sAppCode;
        }

        private  void ValidateRequired(LaboratoryTable info)
        {
            /*if (info != null)
            {
        ...
        private  void ValidateRepeat(LaboratoryTable  info)
        {
            /*if (info != null)
            {
                 try
                 {
                     ILaboratoryTable  infoDAL = LaboratoryTableFactory.Create(this.connStr, this.appCode);
        ...
        public  bool AddNewRecord(LaboratoryTable info)
        {
            try
            {
        ...
        public  bool UpdateRecord(LaboratoryTable info)
        {
            try
            {
                 //ValidateRequired(info);
        ...
        public  LaboratoryTable GetRecordByNo(string sNo)
        {
            if (sNo.Length > 0)
            {
                try
                {
                  ILaboratoryTable  infoDAL = LaboratoryTableFactory.Create(this.connStr, this.appCode);
                  LaboratoryTableCollections infoColl = infoDAL.GetRecordsByNo(sNo);
        ...
        public  LaboratoryTableCollections GetRecordsByPaging(ref int pageCount,int pageIndex,int pageSize,string condition)
        {
          try
          {
             ILaboratoryTable  infoDAL = LaboratoryTableFactory.Create(this.connStr, this.appCode);
           ...
           s_model.sTableName = "LaboratoryTable";
        ...
        public  LaboratoryTableCollections GetRecordsByPaging(SqlModel s_model)
        {
            if (s_model!=null)
            {
                try
