...
{
    public class LaboratoryInfoBLL
    {
        ...
        public  LaboratoryInfoBLL(string sConnStr, string sAppCode)
        {
           this.connStr = sConnStr;
           this.appCode = sAppCode;
        }

        private  void ValidateRequired(LaboratoryInfo info)
        {
            /*if (info != null)
            {
        ...
        private  void ValidateRepeat(LaboratoryInfo  info)
        {
            /*if (info != null)
            {
                 try
                 {
                     ILaboratoryInfo  infoDAL = LaboratoryInfoFactory.Create(this.connStr, this.appCode);
        ...
        public  bool AddNewRecord(LaboratoryInfo info)
        {
            try
            {
        ...
        public  bool UpdateRecord(LaboratoryInfo info)
        {
            try
            {
                 //ValidateRequired(info);
        ...
        public  LaboratoryInfo GetRecordByNo(string sNo)
        {
            if (sNo.Length > 0)
            {
                try
                {
                  ILaboratoryInfo  infoDAL = LaboratoryInfoFactory.Create(this.connStr, this.appCode);
                  LaboratoryInfoCollections infoColl = infoDAL.GetRecordsByNo(sNo);
        ...
        public  LaboratoryInfoCollections GetRecordsByPaging(ref int pageCount,int pageIndex,int pageSize,string condition)
        {
          try
          {
             ILaboratoryInfo  infoDAL = LaboratoryInfoFactory.Create(this.connStr, this.appCode);
           ...
           s_model.sTableName = "LaboratoryInfo";
        ...
        public  LaboratoryInfoCollections GetRecordsByPaging(SqlModel s_model)
        {
            if (s_model!=null)
            {
                try
