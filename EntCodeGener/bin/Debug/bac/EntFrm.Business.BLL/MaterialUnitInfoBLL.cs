...
{
    public class MaterialUnitInfoBLL
    {
        ...
        public  MaterialUnitInfoBLL(string sConnStr, string sAppCode)
        {
           this.connStr = sConnStr;
           this.appCode = sAppCode;
        }

        private  void ValidateRequired(MaterialUnitInfo info)
        {
            /*if (info != null)
            {
        ...
        private  void ValidateRepeat(MaterialUnitInfo  info)
        {
            /*if (info != null)
            {
                 try
                 {
                     IMaterialUnitInfo  infoDAL = MaterialUnitInfoFactory.Create(this.connStr, this.appCode);
        ...
        public  bool AddNewRecord(MaterialUnitInfo info)
        {
            try
            {
        ...
        public  bool UpdateRecord(MaterialUnitInfo info)
        {
            try
            {
                 //ValidateRequired(info);
        ...
        public  MaterialUnitInfo GetRecordByNo(string sNo)
        {
            if (sNo.Length > 0)
            {
                try
                {
                  IMaterialUnitInfo  infoDAL = MaterialUnitInfoFactory.Create(this.connStr, this.appCode);
                  MaterialUnitInfoCollections infoColl = infoDAL.GetRecordsByNo(sNo);
        ...
        public  MaterialUnitInfoCollections GetRecordsByPaging(ref int pageCount,int pageIndex,int pageSize,string condition)
        {
          try
          {
             IMaterialUnitInfo  infoDAL = MaterialUnitInfoFactory.Create(this.connStr, this.appCode);
           ...
           s_model.sTableName = "MaterialUnitInfo";
        ...
        public  MaterialUnitInfoCollections GetRecordsByPaging(SqlModel s_model)
        {
            if (s_model!=null)
            {
                try
