...
{
    public class LabOpeningInfoBLL
    {
        ...
        public  LabOpeningInfoBLL(string sConnStr, string sAppCode)
        {
           this.connStr = sConnStr;
           this.appCode = sAppCode;
        }

        private  void ValidateRequired(LabOpeningInfo info)
        {
            /*if (info != null)
            {
        ...
        private  void ValidateRepeat(LabOpeningInfo  info)
        {
            /*if (info != null)
            {
                 try
                 {
                     ILabOpeningInfo  infoDAL = LabOpeningInfoFactory.Create(this.connStr, this.appCode);
        ...
        public  bool AddNewRecord(LabOpeningInfo info)
        {
            try
            {
        ...
        public  bool UpdateRecord(LabOpeningInfo info)
        {
            try
            {
                 //ValidateRequired(info);
        ...
        public  LabOpeningInfo GetRecordByNo(string sNo)
        {
            if (sNo.Length > 0)
            {
                try
                {
                  ILabOpeningInfo  infoDAL = LabOpeningInfoFactory.Create(this.connStr, this.appCode);
                  LabOpeningInfoCollections infoColl = infoDAL.GetRecordsByNo(sNo);
        ...
        public  LabOpeningInfoCollections GetRecordsByPaging(ref int pageCount,int pageIndex,int pageSize,string condition)
        {
          try
          {
             ILabOpeningInfo  infoDAL = LabOpeningInfoFactory.Create(this.connStr, this.appCode);
           ...
           s_model.sTableName = "LabOpeningInfo";
        ...
        public  LabOpeningInfoCollections GetRecordsByPaging(SqlModel s_model)
        {
            if (s_model!=null)
            {
                try
