...
{
    public class DeviceIODetailBLL
    {
        ...
        public  DeviceIODetailBLL(string sConnStr, string sAppCode)
        {
           this.connStr = sConnStr;
           this.appCode = sAppCode;
        }

        private  void ValidateRequired(DeviceIODetail info)
        {
            /*if (info != null)
            {
        ...
        private  void ValidateRepeat(DeviceIODetail  info)
        {
            /*if (info != null)
            {
                 try
                 {
                     IDeviceIODetail  infoDAL = DeviceIODetailFactory.Create(this.connStr, this.appCode);
        ...
        public  bool AddNewRecord(DeviceIODetail info)
        {
            try
            {
        ...
        public  bool UpdateRecord(DeviceIODetail info)
        {
            try
            {
                 //ValidateRequired(info);
        ...
        public  DeviceIODetail GetRecordByNo(string sNo)
        {
            if (sNo.Length > 0)
            {
                try
                {
                  IDeviceIODetail  infoDAL = DeviceIODetailFactory.Create(this.connStr, this.appCode);
                  DeviceIODetailCollections infoColl = infoDAL.GetRecordsByNo(sNo);
        ...
        public  DeviceIODetailCollections GetRecordsByPaging(ref int pageCount,int pageIndex,int pageSize,string condition)
        {
          try
          {
             IDeviceIODetail  infoDAL = DeviceIODetailFactory.Create(this.connStr, this.appCode);
           ...
           s_model.sTableName = "DeviceIODetail";
        ...
        public  DeviceIODetailCollections GetRecordsByPaging(SqlModel s_model)
        {
            if (s_model!=null)
            {
                try
