...
{
    public class MaterialClassInfoBLL
    {
        ...
        public  MaterialClassInfoBLL(string sConnStr, string sAppCode)
        {
           this.connStr = sConnStr;
           this.appCode = sAppCode;
        }

        private  void ValidateRequired(MaterialClassInfo info)
        {
            /*if (info != null)
            {
        ...
        private  void ValidateRepeat(MaterialClassInfo  info)
        {
            /*if (info != null)
            {
                 try
                 {
                     IMaterialClassInfo  infoDAL = MaterialClassInfoFactory.Create(this.connStr, this.appCode);
        ...
        public  bool AddNewRecord(MaterialClassInfo info)
        {
            try
            {
        ...
        public  bool UpdateRecord(MaterialClassInfo info)
        {
            try
            {
                 //ValidateRequired(info);
        ...
        public  MaterialClassInfo GetRecordByNo(string sNo)
        {
            if (sNo.Length > 0)
            {
                try
                {
                  IMaterialClassInfo  infoDAL = MaterialClassInfoFactory.Create(this.connStr, this.appCode);
                  MaterialClassInfoCollections infoColl = infoDAL.GetRecordsByNo(sNo);
        ...
        public  MaterialClassInfoCollections GetRecordsByPaging(ref int pageCount,int pageIndex,int pageSize,string condition)
        {
          try
          {
             IMaterialClassInfo  infoDAL = MaterialClassInfoFactory.Create(this.connStr, this.appCode);
           ...
           s_model.sTableName = "MaterialClassInfo";
        ...
        public  MaterialClassInfoCollections GetRecordsByPaging(SqlModel s_model)
        {
            if (s_model!=null)
            {
                try
