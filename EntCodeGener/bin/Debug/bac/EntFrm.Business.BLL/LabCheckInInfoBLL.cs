...
{
    public class LabCheckInInfoBLL
    {
        ...
        public  LabCheckInInfoBLL(string sConnStr, string sAppCode)
        {
           this.connStr = sConnStr;
           this.appCode = sAppCode;
        }

        private  void ValidateRequired(LabCheckInInfo info)
        {
            /*if (info != null)
            {
        ...
        private  void ValidateRepeat(LabCheckInInfo  info)
        {
            /*if (info != null)
            {
                 try
                 {
                     ILabCheckInInfo  infoDAL = LabCheckInInfoFactory.Create(this.connStr, this.appCode);
        ...
        public  bool AddNewRecord(LabCheckInInfo info)
        {
            try
            {
        ...
        public  bool UpdateRecord(LabCheckInInfo info)
        {
            try
            {
                 //ValidateRequired(info);
        ...
        public  LabCheckInInfo GetRecordByNo(string sNo)
        {
            if (sNo.Length > 0)
            {
                try
                {
                  ILabCheckInInfo  infoDAL = LabCheckInInfoFactory.Create(this.connStr, this.appCode);
                  LabCheckInInfoCollections infoColl = infoDAL.GetRecordsByNo(sNo);
        ...
        public  LabCheckInInfoCollections GetRecordsByPaging(ref int pageCount,int pageIndex,int pageSize,string condition)
        {
          try
          {
             ILabCheckInInfo  infoDAL = LabCheckInInfoFactory.Create(this.connStr, this.appCode);
           ...
           s_model.sTableName = "LabCheckInInfo";
        ...
        public  LabCheckInInfoCollections GetRecordsByPaging(SqlModel s_model)
        {
            if (s_model!=null)
            {
                try
