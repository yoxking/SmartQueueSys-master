...
{
    public class MaterialIODetailBLL
    {
        ...
        public  MaterialIODetailBLL(string sConnStr, string sAppCode)
        {
           this.connStr = sConnStr;
           this.appCode = sAppCode;
        }

        private  void ValidateRequired(MaterialIODetail info)
        {
            /*if (info != null)
            {
        ...
        private  void ValidateRepeat(MaterialIODetail  info)
        {
            /*if (info != null)
            {
                 try
                 {
                     IMaterialIODetail  infoDAL = MaterialIODetailFactory.Create(this.connStr, this.appCode);
        ...
        public  bool AddNewRecord(MaterialIODetail info)
        {
            try
            {
        ...
        public  bool UpdateRecord(MaterialIODetail info)
        {
            try
            {
                 //ValidateRequired(info);
        ...
        public  MaterialIODetail GetRecordByNo(string sNo)
        {
            if (sNo.Length > 0)
            {
                try
                {
                  IMaterialIODetail  infoDAL = MaterialIODetailFactory.Create(this.connStr, this.appCode);
                  MaterialIODetailCollections infoColl = infoDAL.GetRecordsByNo(sNo);
        ...
        public  MaterialIODetailCollections GetRecordsByPaging(ref int pageCount,int pageIndex,int pageSize,string condition)
        {
          try
          {
             IMaterialIODetail  infoDAL = MaterialIODetailFactory.Create(this.connStr, this.appCode);
           ...
           s_model.sTableName = "MaterialIODetail";
        ...
        public  MaterialIODetailCollections GetRecordsByPaging(SqlModel s_model)
        {
            if (s_model!=null)
            {
                try
