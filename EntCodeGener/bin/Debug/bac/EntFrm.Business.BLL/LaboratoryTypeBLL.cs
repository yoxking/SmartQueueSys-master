...
{
    public class LaboratoryTypeBLL
    {
        ...
        public  LaboratoryTypeBLL(string sConnStr, string sAppCode)
        {
           this.connStr = sConnStr;
           this.appCode = sAppCode;
        }

        private  void ValidateRequired(LaboratoryType info)
        {
            /*if (info != null)
            {
        ...
        private  void ValidateRepeat(LaboratoryType  info)
        {
            /*if (info != null)
            {
                 try
                 {
                     ILaboratoryType  infoDAL = LaboratoryTypeFactory.Create(this.connStr, this.appCode);
        ...
        public  bool AddNewRecord(LaboratoryType info)
        {
            try
            {
        ...
        public  bool UpdateRecord(LaboratoryType info)
        {
            try
            {
                 //ValidateRequired(info);
        ...
        public  LaboratoryType GetRecordByNo(string sNo)
        {
            if (sNo.Length > 0)
            {
                try
                {
                  ILaboratoryType  infoDAL = LaboratoryTypeFactory.Create(this.connStr, this.appCode);
                  LaboratoryTypeCollections infoColl = infoDAL.GetRecordsByNo(sNo);
        ...
        public  LaboratoryTypeCollections GetRecordsByPaging(ref int pageCount,int pageIndex,int pageSize,string condition)
        {
          try
          {
             ILaboratoryType  infoDAL = LaboratoryTypeFactory.Create(this.connStr, this.appCode);
           ...
           s_model.sTableName = "LaboratoryType";
        ...
        public  LaboratoryTypeCollections GetRecordsByPaging(SqlModel s_model)
        {
            if (s_model!=null)
            {
                try
