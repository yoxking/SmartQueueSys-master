...
namespace EntFrm.Business.BLL
{
    public class DeviceInfoBLL
    {
        ...
        public  DeviceInfoBLL(string sConnStr, string sAppCode)
        {
           this.connStr = sConnStr;
           this.appCode = sAppCode;
        }

        private  void ValidateRequired(DeviceInfo info)
        {
            /*if (info != null)
            {
        ...
        private  void ValidateRepeat(DeviceInfo  info)
        {
            /*if (info != null)
            {
                 try
                 {
                     IDeviceInfo  infoDAL = DeviceInfoFactory.Create(this.connStr, this.appCode);
        ...
        public  bool AddNewRecord(DeviceInfo info)
        {
            try
            {
        ...
        public  bool UpdateRecord(DeviceInfo info)
        {
            try
            {
                 //ValidateRequired(info);
        ...
        public  DeviceInfo GetRecordByNo(string sNo)
        {
            if (sNo.Length > 0)
            {
                try
                {
                  IDeviceInfo  infoDAL = DeviceInfoFactory.Create(this.connStr, this.appCode);
                  DeviceInfoCollections infoColl = infoDAL.GetRecordsByNo(sNo);
        ...
        public  DeviceInfoCollections GetRecordsByPaging(ref int pageCount,int pageIndex,int pageSize,string condition)
        {
          try
          {
             IDeviceInfo  infoDAL = DeviceInfoFactory.Create(this.connStr, this.appCode);
        ...
        public  DeviceInfoCollections GetRecordsByPaging(SqlModel s_model)
        {
            if (s_model!=null)
            {
                try
