...
{
    public class DeviceGuaranteeInfoBLL
    {
        ...
        public  DeviceGuaranteeInfoBLL(string sConnStr, string sAppCode)
        {
           this.connStr = sConnStr;
           this.appCode = sAppCode;
        }

        private  void ValidateRequired(DeviceGuaranteeInfo info)
        {
            /*if (info != null)
            {
        ...
        private  void ValidateRepeat(DeviceGuaranteeInfo  info)
        {
            /*if (info != null)
            {
                 try
                 {
                     IDeviceGuaranteeInfo  infoDAL = DeviceGuaranteeInfoFactory.Create(this.connStr, this.appCode);
        ...
        public  bool AddNewRecord(DeviceGuaranteeInfo info)
        {
            try
            {
        ...
        public  bool UpdateRecord(DeviceGuaranteeInfo info)
        {
            try
            {
                 //ValidateRequired(info);
        ...
        public  DeviceGuaranteeInfo GetRecordByNo(string sNo)
        {
            if (sNo.Length > 0)
            {
                try
                {
                  IDeviceGuaranteeInfo  infoDAL = DeviceGuaranteeInfoFactory.Create(this.connStr, this.appCode);
                  DeviceGuaranteeInfoCollections infoColl = infoDAL.GetRecordsByNo(sNo);
        ...
        public  DeviceGuaranteeInfoCollections GetRecordsByPaging(ref int pageCount,int pageIndex,int pageSize,string condition)
        {
          try
          {
             IDeviceGuaranteeInfo  infoDAL = DeviceGuaranteeInfoFactory.Create(this.connStr, this.appCode);
           ...
           s_model.sTableName = "DeviceGuaranteeInfo";
        ...
        public  DeviceGuaranteeInfoCollections GetRecordsByPaging(SqlModel s_model)
        {
            if (s_model!=null)
            {
                try
