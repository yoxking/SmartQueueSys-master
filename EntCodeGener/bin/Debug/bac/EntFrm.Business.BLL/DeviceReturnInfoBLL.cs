...
{
    public class DeviceReturnInfoBLL
    {
        ...
        public  DeviceReturnInfoBLL(string sConnStr, string sAppCode)
        {
           this.connStr = sConnStr;
           this.appCode = sAppCode;
        }

        private  void ValidateRequired(DeviceReturnInfo info)
        {
            /*if (info != null)
            {
        ...
        private  void ValidateRepeat(DeviceReturnInfo  info)
        {
            /*if (info != null)
            {
                 try
                 {
                     IDeviceReturnInfo  infoDAL = DeviceReturnInfoFactory.Create(this.connStr, this.appCode);
        ...
        public  bool AddNewRecord(DeviceReturnInfo info)
        {
            try
            {
        ...
        public  bool UpdateRecord(DeviceReturnInfo info)
        {
            try
            {
                 //ValidateRequired(info);
        ...
        public  DeviceReturnInfo GetRecordByNo(string sNo)
        {
            if (sNo.Length > 0)
            {
                try
                {
                  IDeviceReturnInfo  infoDAL = DeviceReturnInfoFactory.Create(this.connStr, this.appCode);
                  DeviceReturnInfoCollections infoColl = infoDAL.GetRecordsByNo(sNo);
        ...
        public  DeviceReturnInfoCollections GetRecordsByPaging(ref int pageCount,int pageIndex,int pageSize,string condition)
        {
          try
          {
             IDeviceReturnInfo  infoDAL = DeviceReturnInfoFactory.Create(this.connStr, this.appCode);
           ...
           s_model.sTableName = "DeviceReturnInfo";
        ...
        public  DeviceReturnInfoCollections GetRecordsByPaging(SqlModel s_model)
        {
            if (s_model!=null)
            {
                try
