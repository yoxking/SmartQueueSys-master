...
{
    public class DeviceIOMasterBLL
    {
        ...
        public  DeviceIOMasterBLL(string sConnStr, string sAppCode)
        {
           this.connStr = sConnStr;
           this.appCode = sAppCode;
        }

        private  void ValidateRequired(DeviceIOMaster info)
        {
            /*if (info != null)
            {
        ...
        private  void ValidateRepeat(DeviceIOMaster  info)
        {
            /*if (info != null)
            {
                 try
                 {
                     IDeviceIOMaster  infoDAL = DeviceIOMasterFactory.Create(this.connStr, this.appCode);
        ...
        public  bool AddNewRecord(DeviceIOMaster info)
        {
            try
            {
        ...
        public  bool UpdateRecord(DeviceIOMaster info)
        {
            try
            {
                 //ValidateRequired(info);
        ...
        public  DeviceIOMaster GetRecordByNo(string sNo)
        {
            if (sNo.Length > 0)
            {
                try
                {
                  IDeviceIOMaster  infoDAL = DeviceIOMasterFactory.Create(this.connStr, this.appCode);
                  DeviceIOMasterCollections infoColl = infoDAL.GetRecordsByNo(sNo);
        ...
        public  DeviceIOMasterCollections GetRecordsByPaging(ref int pageCount,int pageIndex,int pageSize,string condition)
        {
          try
          {
             IDeviceIOMaster  infoDAL = DeviceIOMasterFactory.Create(this.connStr, this.appCode);
           ...
           s_model.sTableName = "DeviceIOMaster";
        ...
        public  DeviceIOMasterCollections GetRecordsByPaging(SqlModel s_model)
        {
            if (s_model!=null)
            {
                try
