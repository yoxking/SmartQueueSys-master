...
namespace EntFrm.Business.BLL
{
    public class OutlineInfoBLL
    {
        ...
        public  OutlineInfoBLL(string sConnStr, string sAppCode)
        {
           this.connStr = sConnStr;
           this.appCode = sAppCode;
        }

        private  void ValidateRequired(OutlineInfo info)
        {
            /*if (info != null)
            {
        ...
        private  void ValidateRepeat(OutlineInfo  info)
        {
            /*if (info != null)
            {
                 try
                 {
                     IOutlineInfo  infoDAL = OutlineInfoFactory.Create(this.connStr, this.appCode);
        ...
        public  bool AddNewRecord(OutlineInfo info)
        {
            try
            {
        ...
        public  bool UpdateRecord(OutlineInfo info)
        {
            try
            {
                 //ValidateRequired(info);
        ...
        public  OutlineInfo GetRecordByNo(string sNo)
        {
            if (sNo.Length > 0)
            {
                try
                {
                  IOutlineInfo  infoDAL = OutlineInfoFactory.Create(this.connStr, this.appCode);
                  OutlineInfoCollections infoColl = infoDAL.GetRecordsByNo(sNo);
        ...
        public  OutlineInfoCollections GetRecordsByPaging(ref int pageCount,int pageIndex,int pageSize,string condition)
        {
          try
          {
             IOutlineInfo  infoDAL = OutlineInfoFactory.Create(this.connStr, this.appCode);
           ...
           s_model.sTableName = "OutlineInfo";
        ...
        public  OutlineInfoCollections GetRecordsByPaging(SqlModel s_model)
        {
            if (s_model!=null)
            {
                try
