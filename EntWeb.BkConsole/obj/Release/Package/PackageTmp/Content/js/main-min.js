BUI.use(["bui/menu", "bui/tab"], function(h, l) {
    ...
    BUI.augment(w, {
        ...
        _initContents: function() {
            ...
            A.children().remove();
            $.each(B, function(D, E) {            	
                var F = E.id,hTip=$(".nav-item").eq(D).find("span").html(),
                    C = ['<li class="dl-tab-item ks-hidden"><div class="dl-second-nav"></div><div class="dl_nav_titles"><i class="im-home3"></i><span>', hTip, '</span></div><div class="dl-second-tree" id="J_', F, 'Tree"></div><div class="', s, '-con"><div class="', s, '"></div></div></div><div class="dl-inner-tab" id="J_', F, 'Tab"></div></li>'].join("");
                new $(C).appendTo(A)
            })
        },
        _initDom: function() {
