...
{
    public class SelectCountersController : frmMainController
    {  
        //
        // GET: /System/Role/
        ...
        public override ActionResult List()
        {
            try
            {
                ...
                CounterInfoCollections infoColl = infoBLL.GetRecordsByPaging(ref PageCount, PageIndex, 50, Condition);
