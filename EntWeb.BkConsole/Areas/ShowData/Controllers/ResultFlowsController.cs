...
{
    public class ResultFlowsController : frmMainController
    {
        ...
        public override ActionResult List()
        {
            try
            {
                ...
                DsResultFlowsBLL infoBLL = new DsResultFlowsBLL(PublicHelper.Get_ConnStr(), PublicHelper.Get_AppCode());
                DsResultFlowsCollections infoColl = infoBLL.GetRecordsByPaging(ref PageCount, PageIndex, this.PageSize, Condition);
        ...
        public override ActionResult Detail(string id)
        {
            ...
            {
                DsResultFlowsBLL infoBLL = new DsResultFlowsBLL(PublicHelper.Get_ConnStr(), PublicHelper.Get_AppCode());
                DsResultFlows info = infoBLL.GetRecordByNo(id);
