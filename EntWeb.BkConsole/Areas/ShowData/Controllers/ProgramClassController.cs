...
{
    public class ProgramClassController : frmMainController
    {
        ...
        public override ActionResult List()
        {
            try
            {
                ...
                DsProgramClassCollections infoColl = infoBLL.GetRecordsByPaging(ref PageCount, PageIndex, this.PageSize, Condition);
        ...
        public override ActionResult Add()
        {
            try
            {
                DsProgramClass info = new DsProgramClass();
        ...
        public override ActionResult Edit(string id)
        {
            ...
            {
                DsProgramClassBLL infoBLL = new DsProgramClassBLL(PublicHelper.Get_ConnStr(), PublicHelper.Get_AppCode());
                DsProgramClass info = infoBLL.GetRecordByNo(id);
        ...
        public override ActionResult Save()
        {
            ...
            try
            {
                ...
                DsProgramClassBLL infoBLL = new DsProgramClassBLL(PublicHelper.Get_ConnStr(), PublicHelper.Get_AppCode());
                DsProgramClass info = infoBLL.GetRecordByNo(sNo);
