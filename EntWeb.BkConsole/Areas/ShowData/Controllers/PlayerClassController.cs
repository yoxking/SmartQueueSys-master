...
{
    public class PlayerClassController : frmMainController
    {
        ...
        public override ActionResult List()
        {
            try
            {
                ...
                DsPlayerClassCollections infoColl = infoBLL.GetRecordsByPaging(ref PageCount, PageIndex, this.PageSize, Condition);
        ...
        public override ActionResult Add()
        {
            try
            {
                DsPlayerClass info = new DsPlayerClass();
        ...
        public override ActionResult Edit(string id)
        {
            ...
            {
                DsPlayerClassBLL infoBLL = new DsPlayerClassBLL(PublicHelper.Get_ConnStr(), PublicHelper.Get_AppCode());
                DsPlayerClass info = infoBLL.GetRecordByNo(id);
        ...
        public override ActionResult Save()
        {
            ...
            try
            {
                ...
                DsPlayerClassBLL infoBLL = new DsPlayerClassBLL(PublicHelper.Get_ConnStr(), PublicHelper.Get_AppCode());
                DsPlayerClass info = infoBLL.GetRecordByNo(sNo);
