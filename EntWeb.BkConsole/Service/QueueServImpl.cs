...
namespace EntWeb.BkConsole.Service
{
    public class QueueServImpl
    {
        ...
        public string getWaitingNumByServiceId(string branchNo, string serviceId)
        {
            ...
            try
            {
                codeData.data = PublicHelper.getProcessingCountByServiceNo(branchNo, serviceId).ToString();
                return JsonConvert.SerializeObject(codeData);
            }
            catch (Exception ex)
            {
        ...
        public string getWaitingNumByCounterId(string branchNo, string counterId)
        {
            ...
            try
            {
                codeData.data = PublicHelper.getProcessingCountByCounterNo(branchNo, counterId).ToString();
                return JsonConvert.SerializeObject(codeData);
            }
            catch (Exception ex)
            {
        ...
        public string getWaitingNumByStafferId(string branchNo, string stafferId)
        {
            ...
            try
            {
                codeData.data = PublicHelper.getProcessingCountByStafferNo(branchNo, stafferId).ToString();
                return JsonConvert.SerializeObject(codeData);
            }
            catch (Exception ex)
            {
